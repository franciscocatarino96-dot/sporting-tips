...
export default function ChampionsClassificacaoPage() {
  ...
  useEffect(() => {
    async function loadLeaderboard() {
      ...
      try {
        ...
        // IMPORTANTE:
        // Esta classificação pertence à Champions League
        const data = await getLeaderboard("champions");

        setLeaderboard(data);
      } catch (err) {
        console.error(
          "ERRO AO CARREGAR CLASSIFICAÇÃO CHAMPIONS:",
          err
        );
